 ...
 * 
 * Sellers can add new products with multiple images (saved to product_images table)
 */
...
<head>
    ...
    <style>
        ...
        .gallery-preview { display: flex; gap: var(--spacing-md); flex-wrap: wrap; margin-top: var(--spacing-md); }
        ...
        .gallery-item .remove { position: absolute; top: 4px; right: 4px; background: var(--error); color: white; border-radius: 50%; width: 20px; height: 20px; text-align: center; cursor: pointer; font-size: 12px; line-height: 18px; }
...
<main class="admin-main-content">
    <div class="dashboard-content">
        <h1 style="margin-bottom: var(--spacing-md); font-size: var(--font-2xl); font-weight: var(--font-bold)">Add New Product</h1>
        <p style="margin-bottom: var(--spacing-lg); color: var(--gray-medium)">Fill in the details below to list your product</p>
        ...
        <div class="form-container">
            <form id="product-form" action="<?php echo $baseUrl; ?>php/add-product.php" method="post" enctype="multipart/form-data">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="location" placeholder="e.g., Johannesburg">
                    </div>
                </div>
