...
<head>
    ...
    <style>
        ...
        .filter-btn { padding: 8px 16px; border-radius: var(--radius-md); text-decoration: none; background: var(--white); border: 1px solid var(--border-light); color: var(--gray-dark); transition: all var(--transition-fast); }
        ...
        /* Search Bar */
        .search-bar form { display: flex; gap: var(--spacing-sm); }
        ...
        .search-bar button { padding: 8px 16px; background: var(--primary-color); color: white; border: none; border-radius: var(--radius-md); cursor: pointer; display: flex; align-items: center; gap: 5px; }
        ...
        /* Order Card */
        .order-card { background: var(--white); border-radius: var(--radius-lg); border: 1px solid var(--border-light); overflow: visible; transition: all var(--transition-fast); }
        .order-card:hover { box-shadow: var(--shadow-md); }
        
        /* Order Header */
        .order-header { display: flex; justify-content: space-between; align-items: center; padding: var(--spacing-md); background: var(--gray-bg-light); border-bottom: 1px solid var(--border-light); flex-wrap: wrap; gap: var(--spacing-sm); }
        .order-number { font-weight: var(--font-bold); color: var(--primary-color); font-size: var(--font-lg); }
        .order-date { color: var(--gray-medium); font-size: var(--font-sm); margin-left: var(--spacing-sm); }
        
        /* Order Status Badge */
        .order-status-badge { padding: 4px 12px; border-radius: var(--radius-round); font-size: var(--font-xs); font-weight: var(--font-medium); }
        ...
        .order-status-badge.status-shipped { background: var(--primary-fade); color: var(--primary-color); }
        ...
        .amount-label { font-size: var(--font-sm); color: var(--gray-medium); display: block; margin-bottom: var(--spacing-xs); }
        .amount-value { font-size: var(--font-2xl); font-weight: var(--font-bold); color: var(--primary-color); }
        
        /* Order Footer */
        .order-footer { padding: var(--spacing-md); border-top: 1px solid var(--border-light); display: flex; gap: var(--spacing-sm); flex-wrap: wrap; background: var(--white); }
        .order-footer button { padding: 10px 20px; border-radius: var(--radius-md); cursor: pointer; font-weight: var(--font-medium); font-size: var(--font-sm); transition: all var(--transition-fast); border: none; flex: 0 0 auto; }
        .view-details-btn { background: var(--info-light); color: var(--info); border: 1px solid var(--info); }
        .view-details-btn:hover { background: var(--info); color: white; transform: translateY(-2px); }
        .process-btn { background: var(--warning-light); color: var(--warning); border: 1px solid var(--warning); }
        .process-btn:hover { background: var(--warning); color: white; transform: translateY(-2px); }
        .ship-btn { background: var(--primary-fade); color: var(--primary-color); border: 1px solid var(--primary-color); }
        .ship-btn:hover { background: var(--primary-color); color: white; transform: translateY(-2px); }
