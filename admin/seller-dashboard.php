...
$user_name = $currentUser ? $currentUser->getFullName() : 'Seller';
$profile_image = $currentUser ? $currentUser->getProfileImageUrl() : $baseUrl . 'images/icons/profile-svgrepo-com.svg';
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="dashboard-content">
            ...
            <div class="dashboard-grid">
                <div class="section-card">
                    <div class="section-header">
                        <h2>My Listings</h2><a href="my-products.php" class="view-all-link">View All →</a>
                    </div>
                    <div class="listings-grid" id="listings-grid">
                        <div class="loading-spinner">Loading your products...</div>
                    </div>
                    <div class="add-product-btn-container"><a href="add-product.php" class="add-product-btn"><img src="<?php echo $baseUrl; ?>images/icons/add-svgrepo-com.svg" alt="Add"><span>Add New Product</span></a></div>
                </div>

                <div class="section-card">
                    <div class="section-header">
                        <h2>Recent Orders</h2><a href="my-orders.php" class="view-all-link">View All →</a>
                    </div>
            ...
            <div class="store-summary-card">
                <div class="store-summary-header">
                    <div class="store-avatar"><img src="<?php echo $profile_image; ?>" alt="Store Avatar" onerror="this.src='<?php echo $baseUrl; ?>images/icons/profile-svgrepo-com.svg'"></div>
                    <div class="store-info">
                        <h3><?php echo htmlspecialchars($user_name); ?></h3>
                        <p class="store-role">Seller Account</p><span class="store-status active">Active</span>
                    </div>
                </div>
                <div class="store-summary-actions">
                    <a href="seller-profile.php" class="store-action-link"><img src="<?php echo $baseUrl; ?>images/icons/profile-svgrepo-com.svg" alt="Profile">Edit Profile</a>
                    <a href="<?php echo $baseUrl; ?>php/endpoints/logout.php" class="store-action-link logout"><img src="<?php echo $baseUrl; ?>images/icons/logout-svgrepo-com.svg" alt="Logout">Logout</a>
                </div>
            </div>
        </div>
    </main>
